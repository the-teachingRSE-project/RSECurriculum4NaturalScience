...
such as scientific computing, data science and research data management,
...
The much younger community of RSE professionals to a large extent
consists of people with no formal software engineering education.
It has realized that the increasing importance of computational science,
complexity, demands, size of teams, number of collaboration partners
and generally the need for more ambitious software projects calls for a better
and more systematic making use of knowledge and skills from software engineering.
...
A formal training in research software engineering should produce a new generation of RSEs.
...
They should assume a specific professional identity that also includes
the self-image of a scientist with the associated values, practices,
and functions, and is recognized as an equal member of a domain research team.

Similar efforts were carried out in allied communities and yielded tailored curricula,
...
but different challenges in the past 60 years have led to an estrangement between the fields.
...
In order to bridge this apparent chasm we argue that it is necessary to shape a new identity for a domain in the middle between software engineering and the natural sciences.
This should form the basis for a master's program that gives student's an identity,
that makes them qualified Software Engineer's as well as accepted scientists in the natural sciences that feel intellectually at home in both domains.

In order to answer this question the paper is structured as follows: 
(1) The history of natural science and computing.
(2) The history of software engineering as it relates to research.
(3) What are challenges that define the identity of a research software engineer?
(4) How do the challenges and the identity of a research software engineer inform the planned curriculum for research software engineering?
...
- fast prototyping / short term  vs. longer-term software growth
