...
Established curricula in degree programs educate practitioners of a well defined engineering profession.
...
for computer science students. In addition there is experiences from teaching Research Software Engineering Courses at four German universities in different masters programs described by Bertrand et al. [@Bertrand2025].
An RSE for Natural Sciences curriculum will help professionalize RSE career paths in natural sciences, while also addressing the specific needs of scientists,
...
Starting in the late 1950ies large computer became available to universities and research institutions
and were mainly used in egineering and the natural sciences [@wirth2008].
Consequently, the first high-level language, FORTRAN (FORmula TRANslator),
...
The ever-increasing size and complexity of software systems in military and business applications in the 1960ies
led to a gap between ambitions and achievements in software development regarding performance, reliability and cost.
To address this "software crisis", the first software engineering conferences were held in 1968 and 1969 [@Randell1979; @Buxton1970]. These conferences are frequently cited as the beginning of the field "software engineering".
...
and continues "And in Area 2, our scientific foundations are so slight that one can seriously question whether our current techniques deserve to be called "software engineering."
...
is taught in numerous degree-programs and produces highly sought-after professionals.
...
A direct application of SE techniques in the research context is often not feasible or necessary.
If the developer coincides with user, requirements analysis for example looses importance.
Scientific software development often aims exclusively at the production of code that supports a specific investigation where speed is often of the essence.
Hence, the whole software construction process is frequently best characterized as "rapid prototyping".
In a business-context, the externalization of knowledge about the software in the form of the documentation
...
From this perspective it is not surprising that the community of software developers in science has lost touch with mainstream software engineering,
...
Additionally, the trend toward transdisciplinary projects has introduced more complex requirements due to a more heterogeneous set of stakeholders. Also, the emerging use of large language models (LLMs) in software development processes further requires that the latest results from software engineering research are taken into account [@Farshidi2025].
...
Furthermore, the growing complexity of research, the rise of transdisciplinary collaboration, and the integration of advanced technologies like LLMs have introduced intricate software pipelines across disciplines.
...
Currently, we envision two tracks within said curriculum depending on the Bachelor degree/domain of the students.
...
According to the categorization of the Gesellschaft für Informatik (German Informatics society) [@zukunft2016empfehlungen],
