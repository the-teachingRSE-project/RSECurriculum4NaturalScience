...
While it appears, that software engineering and science have drifted apart,
the ongoing digitalization of society as a whole, and science in particular, 
make it apparent, that a reevaluation of this separation is required.
To be more precise, this has led to a series of, mostly outside, trends in the sciences themselves, but also in the way how science is conducted and organized
that have incurred  the need to incorporate practices from software engineering that hitherto have been neglected in science.

- So far, it was "Good Enough" to have the software developed by a single PhD. But in order to progress a growth of research groups requires a more systematic approach to workflows and team organization.
...
Some of these trends point towards an increase in the administrative complexities while others point to a complexities duw to a deeper integration of research software.
...
the inclusion of traineds Software Engineers into research projects?
...
Since Software is often developed for a personal goal, e.g. the PhD, separation of responsibilities is not really a concern.
Developers, are testers, users, and documentation writers at the same time.
For testing this is even often desirable, since testing can not be handled by external parties because a high level of domain-specific knowledge is required to construct suitable tests for research codes.
On the other hand, formal testing is often less important for scientific code developed and used by one single person in an iterative manner.
An adapted testing strategy that does not swamp PhDs in testing maintenance is needed.
