...
**TODO**: Klar machen, dass es um einen Vorschlag für einen Master geht.
**TODO**: Master-Projekt erwähnen, klar machen, dass es um Typ II geht?
**TODO**: generell: FOKUS. Was sind die Hauptpunkte? Auf denen rumhämmern
  - https://doi.org/10.1109/MCSE.2018.021651343 (Haben wir das schon?)
...
for the purpose of this paper:~~
  - replace with human writing.
  - start in the 20th century
    - ok to mention earlier computational devices, if it directly supports the story
  - but start with a sentence like "sciences have always built computational devices"
  
**TODO**: "growth (Nachhaltigkeit, ...) vs. **prototyping**" schon mal anteasern
**TODO**: human vs **numerical anteasern**
...
**TODO**: fill the gap between 1960 and today, here. Some sort of briding sentence.
  - mention Moore's Law or "explosion of computing power"
  - possibility to go from single calculations to full-blown simulation
  - availability of desktop computers has given rise to "a new type of scientists" (important enough?)
  - mention increase in relevance of simulation and modeling
...
**TODO**: Zuverlässigkeit (aus SE) wird jetzt wichtig (weil jetzt auch in science wichtig, FAIR,
credibility crisis, reproducibility,  etc.)
**TODO**: "**growth** vs. prototyping" schon mal anteasern
**TODO**: **human** vs numerical anteasern?
...
**TODO**: Intro sentence(s) to describe the function of this chapter.
...
Apart from the fact how a lot of research in academia is structured around the PhD,
the ongoing digitalization of society as a whole, and science in particular, have led to a series of mostly outside trends in the sciences themselves
that make it apparent, that a reevaluation of this separation is required.


These changes in the sciences, but also in the way how science is conducted and organized
have incurred the need to incorporate practices from software engineering that hitherto have been neglected.
...
This means that used software now has to provide stable interfaces and be reliable across multiple versions, therefore placing a higher pressure for reliability on the software. Also it occured that buggy software was shipped that was used in science, that led to wrong conclusions in publications [@Miller2006Xray; @Smart2018; @Miller2016fMRI].
...
These are a set of outside trends that have and will characterize science and they clearly show that new complexities beyond the hard domain complexity will become a part of 
the lives of scientists working in the natural science.
Some of these trends point towards an increase in the administrative complexities while others point to a complexities due to a deeper integration of research software.
Both are topics that Software Engineering traditionally has put a strong emphasis on, and has contributed by respective standardized processes.
Even the sciences themselves [@Sandve2013; @Junk2020] have argued for the standardization of scientific development processes.
...
If the new complexities are already well understood by Software Engineering, would a suitable approach not be 
the inclusion of trained Software Engineers into research projects?
We argue that this is not a solution, since,generic graduated Software Engineers
...
The straight-forward adaption of SE techniques has also been rejected in the sciences and are in eed of adaptaions.
...
**TODO**: Klar machen (explizit?), dass das work in progress ist.
**TODO**: Text vor Aufzählung noch etwas kürzen und pointieren.
**TODO**: SWEBOK-Referenz in die Aufzählung
...
- **TODO**: Is it like Wirtschaftsinformatik? GI-Empfehlung Wirtschaftsinformatik as an Example? Take care that it stays clear that we need more than the union of 2 fields.
- **TODO**: "Prerequistes a firm background in natural science methods (Math and domain specific modules)"
