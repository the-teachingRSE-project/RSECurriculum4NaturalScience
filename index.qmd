...
An RSE for Natural Sciences curriculum will help professionalize RSE career
...
Here, the question arises if the mathematical description of a model should be considered the documentation whereas the software only plays the role of proof-of-concept implementations.
