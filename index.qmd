...
In this context a simple working definition of identity [@cuevas2021constructing] is used that describes the self-ascribed field ("I am a physicist" or "I am a computer scientist").
The reason why we use the identity concept in this situation is that it connects both to the historical perspective on natural sciences and how software engineering developed alongside it. But it also provides a basis for a competency framework as canonical knowledge is ascribed to the identity: a fully trained computer scientist (Vollinformatiker) should be able to do x or y. This way the question of identity of a research software engineer will help us both delineate the fields (natural sciences and software engineering) and provide a path to meaningful expectations in terms of master level competencies of a RSE.
...
- the reproducibility crisis [todo @literatur] has lead to standardization of  scientific development processes:
