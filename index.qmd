...
1. software engineering foundation and required computer science modules
   - Here a selection of topics from SE is taught. E.g. Computer Architecture, Visualization, Distributed Systems, Software Architecture. (Selection from Uni Stuttgart, SE Master)
